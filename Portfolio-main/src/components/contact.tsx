      ...
      <div className="rounded-organic bg-accent w-full overflow-hidden px-6 py-8 font-sans sm:px-10 md:px-16 md:py-12">
        ...
        <div className="mt-8 flex flex-col md:mt-10">
          <a
            ...
            className="group mb-2 flex w-fit items-center gap-1 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
          ...
          <a
            ...
            className="group mb-5 flex w-fit items-center gap-1 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-5 sm:gap-x-8">
            {contactInfo.socials.map((social) => (
              <a
                ...
                className="text-muted-foreground hover:text-foreground rounded-sm text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                title={social.name}
              >
                {social.name}
              </a>
