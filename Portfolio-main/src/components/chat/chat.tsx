    ...
    <div className="relative h-[100dvh] overflow-hidden">
      <div className="absolute top-3 right-3 z-51 flex flex-row items-center justify-center gap-1 sm:top-6 sm:right-8 sm:gap-2">
        <button
          ...
          title="Home"
          aria-label="Home"
          className="hover:bg-accent cursor-pointer rounded-xl px-2 py-1 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none sm:rounded-2xl sm:px-3 sm:py-1.5"
        >
          <svg
