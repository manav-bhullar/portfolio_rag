...
export default function WelcomeModal({ trigger }: WelcomeModalProps) {
  ...
  const defaultTrigger = (
    <Button
      variant="ghost"
      className="pressable h-11 w-11 cursor-pointer rounded-full p-0 hover:bg-accent focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 md:h-12 md:w-12"
    ...
    <>
      ...
      >
        <div className="space-y-4 pb-2">
          <section className="space-y-6 rounded-2xl bg-accent p-5 sm:p-7">
            <div className="space-y-2">
              ...
              <p className="text-accent-foreground text-[15px] leading-relaxed sm:text-base">
                ...
                curious, feel free to ask anything you want — projects, skills,
                education, or even my personal interests.
              </p>
            </div>

            <div className="space-y-2">
              <h3 className="text-primary text-lg font-semibold sm:text-xl">Why?</h3>
              <p className="text-accent-foreground text-[15px] leading-relaxed sm:text-base">
                Traditional portfolios can&apos;t adapt to every visitor&apos;s
                specific needs. With this AI approach, my portfolio becomes{' '}
                <strong>exactly what you&apos;re interested in knowing about me and my work.</strong>
              </p>
            </div>
          </section>
