...
import { Laugh, BriefcaseBusiness, Layers, PartyPopper, UserRoundSearch, BarChart3 } from 'lucide-react';
  ...
  return (
    <div className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden bg-background px-4 py-20 sm:py-16">
      ...
      >
        ...
        {/* free-form question */}
        <SearchForm goToChat={goToChat} bottomElementVariants={bottomElementVariants} />
