...
- exploreProject is a deep dive into exactly ONE project. For comparisons between projects ("Floq vs SCALES"), or any question spanning several projects, do NOT call exploreProject or any other tool: calling a tool ends your turn before you can write the comparison. Answer in text from the retrieved context.
