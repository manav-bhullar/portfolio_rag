...
export default function Chat() {
  ...
  // Wrapped the O(N) array iteration in useMemo. This prevents the calculation
  // from running on every single keystroke as the user types (which updates the
  // `input` state in useChat and triggers a re-render of this component).
