...
const buttonVariants = cva(
  // M3 spec: buttons default to the Full corner-radius step (see
  // .claude/skills/m3-expressive/references/tokens.md quick reference —
  // "Buttons default to full") — not a small fixed radius.
